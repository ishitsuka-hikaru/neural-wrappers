...
class TestStaticBatchedDatasetReader:
	...
	def test_getNumIterations_1(self):
		reader = BaseReader()
		reader1 = StaticBatchedDatasetReader(reader, batchSize=1)
		reader2 = StaticBatchedDatasetReader(reader, batchSize=2)
	...
	def test_iterateOneEpoch(self):
		...
		reader2 = StaticBatchedDatasetReader(baseReader, batchSize=2)
...
def main():
	...
	TestStaticBatchedDatasetReader().test_iterateOneEpoch()
